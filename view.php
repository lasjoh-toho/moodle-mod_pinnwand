...
$config = [
    ...
    'strings' => [
        ...
        'tf_panels_collapse' => get_string('tf_panels_collapse', 'pinnwand'),
        'tf_panels_expand' => get_string('tf_panels_expand', 'pinnwand'),
        'tf_debug_svg' => get_string('tf_debug_svg', 'pinnwand'),
        'tf_debug_svg_error' => get_string('tf_debug_svg_error', 'pinnwand'),
        'tf_margin_hint' => get_string('tf_margin_hint', 'pinnwand'),
        'tf_margin_label' => get_string('tf_margin_label', 'pinnwand'),
        'tf_margin_auto' => get_string('tf_margin_auto', 'pinnwand'),
