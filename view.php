...
$config = [
    ...
    'strings' => [
        ...
        'hideannotations' => get_string('hideannotations', 'pinnwand'),
        'showannotations' => get_string('showannotations', 'pinnwand'),
        ...
        'selection_add' => get_string('selection_add', 'pinnwand'),
        'boxselect' => get_string('boxselect', 'pinnwand'),
        ...
        'trashbin_placement_label' => get_string('trashbin_placement_label', 'pinnwand'),
        'trashbin_restore' => get_string('trashbin_restore', 'pinnwand'),
        'trashbin_delete_forever' => get_string('trashbin_delete_forever', 'pinnwand'),
        'trashbin_delete_forever_confirm' => get_string('trashbin_delete_forever_confirm', 'pinnwand'),
        'step' => get_string('step', 'pinnwand'),
        'filterbar' => get_string('filterbar', 'pinnwand'),
        'filterbar_placeholder' => get_string('filterbar_placeholder', 'pinnwand'),
        'filterbar_clear' => get_string('filterbar_clear', 'pinnwand'),
        ...
        'cloneboard' => get_string('cloneboard', 'pinnwand'),
        'cloneboard_confirm' => get_string('cloneboard_confirm', 'pinnwand'),
        'boardhide' => get_string('boardhide', 'pinnwand'),
        'boardshow' => get_string('boardshow', 'pinnwand'),
        'boardswitcher' => get_string('boardswitcher', 'pinnwand'),
        'boardrename_hint' => get_string('boardrename_hint', 'pinnwand'),
        ...
        'addwordart' => get_string('addwordart', 'pinnwand'),
        ...
        'fontweight' => get_string('fontweight', 'pinnwand'),
        'tfblock_templates' => get_string('tfblock_templates', 'pinnwand'),
        'tf_shape_bg' => get_string('tf_shape_bg', 'pinnwand'),
        'tf_shape_fg' => get_string('tf_shape_fg', 'pinnwand'),
        'tf_shape_rect' => get_string('tf_shape_rect', 'pinnwand'),
        'tf_shape_rounded' => get_string('tf_shape_rounded', 'pinnwand'),
        'tf_shape_circle' => get_string('tf_shape_circle', 'pinnwand'),
        'tf_shape_ellipse' => get_string('tf_shape_ellipse', 'pinnwand'),
        'tf_shape_none' => get_string('tf_shape_none', 'pinnwand'),
        'tf_shape_star' => get_string('tf_shape_star', 'pinnwand'),
        'tf_shape_ribbon' => get_string('tf_shape_ribbon', 'pinnwand'),
        'tf_shape_badge' => get_string('tf_shape_badge', 'pinnwand'),
        'tf_fill' => get_string('tf_fill', 'pinnwand'),
        'tf_outline' => get_string('tf_outline', 'pinnwand'),
        'tf_effects' => get_string('tf_effects', 'pinnwand'),
        ...
        'wordart_extrude_color' => get_string('wordart_extrude_color', 'pinnwand'),
        'wordart_rotate' => get_string('wordart_rotate', 'pinnwand'),
        'wordart_skew' => get_string('wordart_skew', 'pinnwand'),
        'wordart_scaley' => get_string('wordart_scaley', 'pinnwand'),
        'wordart_glow' => get_string('wordart_glow', 'pinnwand'),
        'wordart_sample_word' => get_string('wordart_sample_word', 'pinnwand'),
        'wordart_arc_title' => get_string('wordart_arc_title', 'pinnwand'),
        'wordart_arc_none' => get_string('wordart_arc_none', 'pinnwand'),
        'wordart_arc_up' => get_string('wordart_arc_up', 'pinnwand'),
        'wordart_arc_down' => get_string('wordart_arc_down', 'pinnwand'),
        ...
        'align_center' => get_string('align_center', 'pinnwand'),
        'align_right' => get_string('align_right', 'pinnwand'),
        'align_justify' => get_string('align_justify', 'pinnwand'),
        'tf_recent_colors' => get_string('tf_recent_colors', 'pinnwand'),
        'tf_opacity' => get_string('tf_opacity', 'pinnwand'),
        'tf_group_char' => get_string('tf_group_char', 'pinnwand'),
        'tf_group_para' => get_string('tf_group_para', 'pinnwand'),
        'tf_tab_grid' => get_string('tf_tab_grid', 'pinnwand'),
        'tf_tab_wheel' => get_string('tf_tab_wheel', 'pinnwand'),
        'tf_wrap_front' => get_string('tf_wrap_front', 'pinnwand'),
        'tf_wrap_behind' => get_string('tf_wrap_behind', 'pinnwand'),
        'tf_wrap_around' => get_string('tf_wrap_around', 'pinnwand'),
        ...
        'pintooltip' => get_string('pintooltip', 'pinnwand'),
        'unpintooltip' => get_string('unpintooltip', 'pinnwand'),
        ...
        'addobject' => get_string('addobject', 'pinnwand'),
        'category_image' => get_string('category_image', 'pinnwand'),
        'category_text' => get_string('category_text', 'pinnwand'),
